...
//     }
    ...
    BufferedImage process(BufferedImage input, int targetW, int targetH) throws IOException;

    BufferedImage processSmart(BufferedImage input, SmartCropResponse crop, int targetW, int targetH) throws IOException;
}
